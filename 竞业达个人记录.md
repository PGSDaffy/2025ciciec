...
- [x] 阅读pa2阶段2讲义
### 过程记录
1.我的理解有问题其实伪指令其实是汇编语言的一种抽象而已，对于处理器而言其实处理的就是对应的基础指令，所以只要实现了所有的基础指令就可以不用管别的。rv手册第三章有总结伪指令。
2.目前一共加了很多条指令都没有脱离他已经写好的R
### 遭遇问题
### 备注
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTMzMDA4NzE0LDE2NTMyNzk2NzgsLTE2Mz
YxMDI5NzYsLTE0ODgwOTIxNzksMTE0OTExODMzNiwxMTkwOTI0
NzY2LC02NzYwMjcyMDcsMTEyNDU4NTA4MiwxMjM4Mzg0NjI5LC
00NTE1MjI1MDEsLTE2NzY4MzUzNTcsLTc2NjcxNjU1Ml19
-->